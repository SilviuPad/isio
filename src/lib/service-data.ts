    ...
    sections: [
      ...
      },
      {
        ...
        prose: [
          ...
          {
            ro: 'ISIO se concentreaza pe SEO tehnic si on-page deoarece acestea sunt domeniile in care experienta in cod poate aduce cel mai mare impact. Optimizarile tehnice (viteza, structured data, crawlability) au efect imediat si durabil, spre deosebire de tacticile de link building care pot fi penalizate de Google. Rezultatul: crestere organica sustenabila construita pe fundamente tehnice solide.',
            en: 'ISIO focuses on technical and on-page SEO because these are the areas where coding expertise can bring the greatest impact. Technical optimizations (speed, structured data, crawlability) have immediate and lasting effect, unlike link building tactics that can be penalized by Google. The result: sustainable organic growth built on solid technical foundations.',
          },
        ],
        items: [],
      },
        ...
        prose: [
          {
            ...
            en: 'The ISIO accessibility audit combines automated testing with thorough manual evaluation to identify real barriers that users with disabilities encounter in daily use. We use axe-core and Lighthouse for automated scanning, but these tools detect only 30-40% of real issues. That is why every audit includes manual testing with screen readers (NVDA and VoiceOver), keyboard-only navigation, and color contrast verification across all interactive states.',
          },
          {
    ...
    sections: [
      {
        ...
        items: [
          ...
          { text: { ro: 'Management complet opțional (hosting, monitorizare, actualizări)', en: 'Optional full management (hosting, monitoring, updates)' } },
        ],
      },
      {
        id: 'deliverables',
